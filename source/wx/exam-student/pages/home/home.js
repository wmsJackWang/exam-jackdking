...
Page({
  ...
  data: {
      ...
      swiperImg:[
        {
          img:"/assets/swiper/1.png"
        },
        {
          img:"/assets/swiper/2.png"
        },
        {
          img:"/assets/swiper/3.png"
        },
        {
          img:"/assets/swiper/4.png"
        }
      ],
      /**房东直卖  优选房源 图标接口数据 */
      maifangImg:[
  ...
  gotoSelf:function(e){
    ...
    if(num == 0){
      wx.navigateTo({
        url: '/pages/exam/index/index?id='+2,
        fail: function(res) {
          console.log('navigateTo more page fail' + JSON.stringify(res))
        },
      ...
      wx.navigateTo({
        url: '/pages/exam/index/index?id='+5
      })
    }else if (num == 2){
      wx.navigateTo({
        url: '/pages/article/list/articleList'
      })
    }else if (num == 3){
      wx.navigateTo({
        url: '/pages/record/index?id='+2
      })
    }else if (num == 4){
      wx.navigateTo({
        url: '/pages/exam/index/index?id='+3
      })
    }else if (num == 5){
      wx.navigateTo({
        url: '/pages/exam/index/index?id='+2
      ...
      wx.navigateTo({
        url: '/pages/record/index?id='+1
      })
    }else if (num == 7){
      wx.navigateTo({
        url: '/pages/record/index?id='+3
      })
    }
  },
	phone() {
