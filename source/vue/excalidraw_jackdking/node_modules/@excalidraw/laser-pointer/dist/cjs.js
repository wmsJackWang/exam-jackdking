...
class $a05669264f67e39b$export$6531021b3bf36eae {
    ...
    getStrokeOutline(sizeOverride) {
        ...
        for(let theta = 0; theta <= Math.PI; theta += Math.PI / 16)endCap.push($7635cb696243d7e2$export$e16d8520af44a096(ultimate, $7635cb696243d7e2$export$855df823ceb9b81b($7635cb696243d7e2$export$1c8884ee32bdf443(ppdirPU, -endCapSize), -theta)));
        const strokeOutline = [
            ...startCap,
            ...forwardPoints,
            ...endCap.reverse(),
