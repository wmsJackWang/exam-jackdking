...
> => {
  ...
  console.log('isExternalScene:' + JSON.stringify(isExternalScene));
  console.log('externalUrlMatch:' + externalUrlMatch);
  if (isExternalScene) {
    if (
    ...
    console.log('externalUrlMatch: data');
    window.history.replaceState({}, APP_NAME, window.location.origin);
  ...
  console.log('opts.collabAPI:' + JSON.stringify(opts.collabAPI));
  ...
  if (roomLinkData && opts.collabAPI) {
    ...
    const  retData = isExternalScene && jsonBackendMatch
      ? {
        scene,
        isExternalScene,
  ...
  useEffect(() => {
    ...
    const loadImages = (
      ...
      if (collabAPI?.isCollaborating()) {
        ...
        console.log('scence  init...................')
        console.log('scence  init  data...................' + JSON.stringify(data))
