(function (factory) {
    ...
    exports.hsl2Hsv = exports.hsv2Hsl = exports.cmyk2Rgb = exports.rgb2Cmyk = exports.hex2Hsl = exports.hsl2Hex = exports.hex2Hsv = exports.hsv2Hex = exports.hex2Rgb = exports.rgb2Hex = exports.hsv2Rgb = exports.hsl2Rgb = exports.rgb2Hsv = exports.rgb2Hsl = void 0;
    ...
    function hex2Rgb(color) {
        var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec((0, utils_1.normalizeHex)(color));
        return result ? {
    ...
    function hex2Hsv(color) {
        var rgb = hex2Rgb((0, utils_1.normalizeHex)(color));
        return rgb2Hsv(rgb);
    }
