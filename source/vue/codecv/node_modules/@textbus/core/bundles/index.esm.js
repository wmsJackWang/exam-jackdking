...
import { InjectionToken, Injector, Injectable, Inject, Prop, Scope, ReflectiveInjector, NullInjector, normalizeProvider } from '@tanbo/di';
export * from '@tanbo/di';
import { Subject, map, distinctUntilChanged, share, Subscription, take, microTask } from '@tanbo/stream';
 ...
 */
let PureRenderer = PureRenderer_1 = class PureRenderer {
    /**
     * 组件渲染方法
    ...
    slotRender(component, slot, slotRenderFactory) {
        ...
        if (slot.changeMarker.dirty || this.readonlyStateChanged) {
            ...
            let children = formatTree.children ?
                ...
                PureRenderer.createVDomByContent(slot, formatTree.startIndex, formatTree.endIndex, renderMode, componentRender, setLocation);
            if (formatTree.formats) {
 ...
 * Textbus 历史记录管理类
 */
let LocalHistory = class LocalHistory extends History {
    /**
     * 历史记录是否可回退
     */
    get canBack() {
...
Keyboard = __decorate([
    ...
    __metadata("design:paramtypes", [Array, Boolean, Commander,
        Injector,
        Selection])
], Keyboard);
 ...
 * Textbus 输出渲染器
 */
let OutputRenderer = class OutputRenderer {
 ...
 * Textbus 内核启动器
 */
class Starter extends ReflectiveInjector {
    constructor(config) {
        var _a;
...
export { ATTRIBUTE_LIST, Attribute, COMPONENT_LIST, ChangeMarker, ChangeOrigin, Commander, Content, ContentType, ContextMenuEvent, Controller, DeltaLite, Event, FORMATTER_LIST, Format, Formatter, Fragment, GetRangesEvent, HISTORY_STACK_SIZE, History, Keyboard, LocalHistory, NativeRenderer, NativeSelectionBridge, OutputRenderer, PureRenderer, Query, QueryStateType, READONLY, Ref, Registry, RenderMode, Renderer, RootComponentRef, Scheduler, Selection, Slot, Slots, Starter, VElement, VFragment, VTextNode, ZEN_CODING_DETECT, defineComponent, invokeListener, jsx, jsxs, makeError, onBlur, onBreak, onCompositionEnd, onCompositionStart, onCompositionUpdate, onContentDelete, onContentDeleted, onContentInsert, onContentInserted, onContextMenu, onDestroy, onDirtyViewClean, onFocus, onFocusIn, onFocusOut, onGetRanges, onParentSlotUpdated, onPaste, onSelected, onSelectionFromEnd, onSelectionFromFront, onSlotRemove, onSlotRemoved, onUnselect, onViewChecked, onViewInit, triggerContextMenu, useContext, useDynamicShortcut, useRef, useSelf, useSlots, useState };
