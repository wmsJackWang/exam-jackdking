...
const state = {
  user: {
    ...
    levelEnum: [{ key: 1, value: '1-3年' }, { key: 2, value: '3-5年' }, { key: 3, value: '5-7年' }, { key: 4, value: '7-10年' }, { key: 5, value: '10年以上' }],
  ...
  knowledge: {
    knowledgeTypeEnum: [{ key: 'Q', value: '主要问题' }, { key: 'I', value: '核心概念' }, { key: 'R', value: '重要关系' }, { key: 'C', value: '应用场景' }, { key: 'A', value: '所有' }]
  },
  exam: {
    examPaper: {
